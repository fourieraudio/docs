...
1. **Deactivate your existing Suite 25 licence** (internet-connected computer)
   - Open **transform**.client → Settings → **Plugin Collections** and deactivate your current Suite 25 licence.

2. **Obtain the Suite '26 licence** (there are two methods):
   - **In-place upgrade**
     - Log into your licence manager and select the **Upgrade** button next to the relevant licence. Credit calculations are applied automatically and any balance is paid by credit card.
   - **Redeem a licence or activation key**
     - If you have a redeem code or need to redeem online, go to: https://fourier.completeaccess.audio/redeem and follow the prompts.

3. **Assign the Suite 26 licence to an engine**
   - In your licence manager, assign the new Suite 26 licence to the desired engine.
